      ...
      <div className="sticky top-16 z-30 border-b border-slate-200 bg-white/85 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl flex-wrap items-center gap-x-4 gap-y-2 px-4 py-3 sm:px-6 lg:px-8">
          <input
            ...
            className="h-9 w-full max-w-xs rounded-lg border border-transparent px-2 text-sm font-bold text-slate-900 transition-colors hover:border-slate-300 focus:border-indigo-500 focus:bg-white focus:outline-none focus:ring-2 focus:ring-indigo-100 sm:w-auto"
          />
  ...
  return (
    <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
      <h2 className="mb-4 flex items-center gap-2.5 font-bold text-slate-900">
        <span className="flex size-7 items-center justify-center rounded-lg bg-gradient-to-br from-fuchsia-500 to-pink-600 text-xs font-bold text-white">
          {step}
        </span>
        {title}
      </h2>
